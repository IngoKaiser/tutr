...
- **Eltern sehen, _was_ gelernt wird – nicht, _wie gut_ es läuft** (ADR 0012). Bei ihnen bleiben Termine, Konto/Geräte, Fächer/Schuljahr, Noten und der Stoffplan (Themen, Lernziele, Vokabellisten). **Kein** Zugriff auf Lernstand und Protokoll: `card`, `review`, `objective_mastery`, `homework_task`, `tutor_session_summary` – und wie bisher **nie** `tutor_session`/`tutor_message`. Wo Eltern doch etwas sehen sollen, teilt das Kind es aktiv. Das wird in RLS erzwungen, nicht nur in der UI.
