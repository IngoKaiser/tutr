 ...
 *
 * Trug bis L-02 einen dritten Posten für das Websuche-Tool (0,01 $ je Suche,
 * L-01 „Claude sucht das Lehrwerk"): Eine einzelne Suche kostete dort real
 * 0,37–0,51 $ – 124–171 % des gesamten Stundendeckels in einem Aufruf,
 * strukturell, nicht nur bei Pech. Mit der Websuche ist auch dieser Posten
 * wieder raus, siehe `docs/PLAN.md` L-02.
 */
