...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| **Worktree `practical-pike-e96dba` entfernen** und den Branch `claude/v-03d-v-06a-vokabeln` löschen:<br>`git worktree remove ".claude/worktrees/practical-pike-e96dba" && git branch -D claude/v-03d-v-06a-vokabeln` | PR #90 ist gemerged, `--delete-branch` konnte den Branch aber nicht entfernen, weil er im Worktree ausgecheckt ist. Muss aus dem Hauptverzeichnis laufen, nicht aus dem Worktree selbst | 2026-09-12 |
