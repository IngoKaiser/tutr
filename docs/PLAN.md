...
| ---- | --------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------ | -------------------------------------- |
| F-01 | Repo-Setup prüfen: `npm run check` grün, Hooks aktiv, CI grün auf GitHub                                                                      | –           | todo   | `scripts/bootstrap.sh`                 |
| F-02 | Supabase-Projekt (EU/Frankfurt) anlegen, `.env.local`, Verbindung testen                                                                      | §11         | todo   | manuell + Claude Code für Client-Setup |
| F-03 | **[opusplan]** ADR 0003: Datenmodell + RLS-Strategie; Drizzle-Schema für Family, User, Student, SchoolYear, Subject, Thema, LearningObjective | §8, §9, §10 | todo   | `/plan-session Datenmodell`            |
