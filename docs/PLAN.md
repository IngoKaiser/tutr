...
| F-04b | Schema Familie/Identität: `family`, `parent_user`, `student` + Policies + Tests                                                                                   | §8          | done   | Erste Migration; `db:migrate` wendet jetzt Migrationen **und** Policies an. Kind sieht nur das eigene Profil, ändert nichts                                          |
