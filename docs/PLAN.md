...
| F-07  | App-Shell: 5 Bereiche (Heute, Fächer, Üben, Prüfungen, Tutor), Mobile-Navigation, PWA-Manifest, Serwist                                                              | §5, §11     | todo   | **Vorgezogen vor F-05/F-06**: hängt nicht an echter Auth, ein Dev-Actor (Eltern/Kind-Umschalter) reicht. Lighthouse-PWA-Check                                                           |
...
| F-04e | Seed-Skript `npm run db:seed`: zwei Familien, Geschwisterkind, Fächer, ein Thema mit Lernzielen                                                                      | §8          | todo   | **Nach F-07 geschoben**: die Policy-Tests bauen ihre Fixtures selbst, der Seed nützt erst beim Ausprobieren in der UI                                                                   |
