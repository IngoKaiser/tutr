...
| F-04d | Schema Referenzdaten: `curriculum_pack`, `curriculum_node`, `textbook`, `chapter`, `school_profile`, `school_year_textbook` + Shared-Read-Policy | §7          | todo   | ADR 0004 D7; `topic.curriculum_node_ref`/`textbook_ref` bekommen dann ihre Fremdschlüssel                                                                                               |
