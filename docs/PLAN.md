...
| F-04c | Schema `school_year`, `subject`, `school_year_textbook`, `topic`, `learning_objective`, `objective_prerequisite` inkl. Fachbindungs-Constraint + Policies + Tests | §8, §9, §10 | todo   | ADR 0004 D3/D6; Test für §15 Fehler 2                                                                                                                                                   |
| F-04d | Schema Referenzdaten: `curriculum_pack`, `curriculum_node`, `textbook`, `chapter`, `school_profile` + Shared-Read-Policy                                          | §7          | todo   | ADR 0004 D7                                                                                                                                                                             |
